...
import type { Region, Segment, SegmentMembership, TargetCriteria } from "@/lib/data/contracts";
...
function segmentTargetUrl(segment: Segment, region: Region): string {
...
export function SegmentsView({ region, segments }: Props) {
