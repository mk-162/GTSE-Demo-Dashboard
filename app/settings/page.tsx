      ...
      <CardContent className="space-y-4">
        <div className="rounded-sm border-l-4 border-l-amber-500 bg-amber-500/5 p-3 text-xs">
          <div className="flex items-start gap-2">
            <AlertTriangle className="mt-0.5 h-3.5 w-3.5 shrink-0 text-amber-600" />
            <div>
              <strong>Available once Phase 1 ships.</strong> The current demo data lives in TypeScript modules. When the real warehouse goes live (Vercel Postgres / Neon, populated by nightly Vercel Cron jobs from HubSpot), this is the connection string developers will use.
            </div>
          </div>
        </div>
